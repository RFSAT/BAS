    ...
    fun restore(context: Context) {
        ...
        runCatching {
            ...
            if (p == null || p.windSamples == null || p.adjustment == null ||
                ...
                com.rfsat.bas.log.Logger.w("AnalysisSession", "Stored payload incomplete — ignoring it")
                return
            }
            ...
            com.rfsat.bas.log.Logger.w("AnalysisSession", "Stored payload unreadable — ignoring it: ${it.message}")
        }
    }
}
