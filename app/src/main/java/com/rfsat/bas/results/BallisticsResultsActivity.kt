...
class BallisticsResultsActivity : BaseActivity() {
    ...
    private lateinit var binding: ActivityBallisticsResultsBinding
    ...
    private fun promptWindTransfer() {
        ...
        val spinner = android.widget.Spinner(this).apply {
            adapter = android.widget.ArrayAdapter(
                this@BallisticsResultsActivity, android.R.layout.simple_spinner_dropdown_item, sets.map { it.name })
        }
