...
import com.rfsat.bas.databinding.ActivityResultsBinding
...
import com.rfsat.bas.detect.DetectedHole
import com.rfsat.bas.detect.FocusedRemeasure
...
import com.rfsat.bas.scoring.ScoredPhoto
import com.rfsat.bas.scoring.ScoringSession
import com.rfsat.bas.scoring.Shot
...
class ResultsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnShare.setOnClickListener { share(ScoringSession.asReport(this), "BAS session report") }
        binding.btnCsv.setOnClickListener { share(ScoringSession.asCsv(), "BAS shots CSV") }
    ...
    private fun refresh() {
        ...
        if (allWarnings.isEmpty()) {
            ...
            binding.tvWarnings.text =
                com.rfsat.bas.ui.Bullets.list(allWarnings, binding.tvWarnings.textSize)
        }
