...
class CaptureActivity : BaseActivity() {
    ...
    private fun maybeOfferScopeGeometry() {
        val scope = com.rfsat.bas.profiles.ProfileRepository(this).getScope()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvTargetLabel.text =
            "Target (${com.rfsat.bas.ui.UnitsManager.distanceUnitLabel()})"
    ...
    private fun readKestrel() {
        ...
        val bonded = com.rfsat.bas.environment.KestrelProvider.findPairedKestrel()
        if (bonded != null) {
    ...
    private fun saveCaptureFields() {
        ...
        binding.etTargetDistance.text.toString().toDoubleOrNull()?.let {
            e.putFloat(KEY_DISTANCE_M, com.rfsat.bas.ui.UnitsManager.inputDistanceToMeters(it).toFloat())
        }
    ...
    private fun restoreCaptureFields() {
        ...
        if (distM > 0f) {
            val display = com.rfsat.bas.ui.UnitsManager.displayDistance(distM.toDouble())
    ...
    private fun toggleStreamRecording() {
        ...
        if (active != null) {
            ...
            streamRecorder = null
            releaseScopeNetwork()
            binding.btnRecord.text = getString(com.rfsat.bas.R.string.record)
            val f = java.io.File(cacheDir, "scope_stream.mp4")
        ...
        stopIdlePreview()
        binding.btnRecord.text = getString(com.rfsat.bas.R.string.stop)
    ...
    private fun toggleRecording() {
        ...
        startRecordingInternal { binding.btnRecord.text = getString(com.rfsat.bas.R.string.stop) }
    }
    ...
    private fun onShotDetected() {
        ...
        startRecordingInternal {
            ...
            val tof = BallisticsEngine.zeroedTimeOfFlight(
                ...
                com.rfsat.bas.results.AdjustmentCalculator.effectiveSightHeightM(zeroRifle, zeroScope)
            )
    ...
    private fun runAnalysis() {
        ...
        lifecycleScope.launch(Dispatchers.Default) {
            try {
                ...
                val atmosphere = com.rfsat.bas.environment.EnvironmentManager.current.atmosphere
                Logger.i(TAG, "Analysis environment: ${com.rfsat.bas.environment.EnvironmentManager.describe()}")
                ...
                val rawSamples = if (effectivePointTracked) {
                    com.rfsat.bas.wind.TracerWindEstimator.estimate(
                ...
                val adjustment = AdjustmentCalculator.computeAdjustment(
                    com.rfsat.bas.profiles.TruingStore.applied(
                        this@CaptureActivity, activeRifle, bullet),
                    activeRifle, scope, atmosphere, targetDistanceYd, anchored,
                    geometry = com.rfsat.bas.environment.ShotOrientation.geometry(
                ...
                com.rfsat.bas.profiles.ProfileRepository(this@CaptureActivity).let { rp ->
                ...
                withContext(Dispatchers.Main) {
                    ...
                    startActivity(Intent(this@CaptureActivity, BallisticsResultsActivity::class.java))
                }
            } catch (t: Throwable) {
    ...
    private fun readTargetDistanceMeters(): Double {
        val typed = binding.etTargetDistance.text.toString().toDoubleOrNull()
            ?: if (com.rfsat.bas.ui.UnitsManager.isImperial()) 100.0 else 100.0
        return com.rfsat.bas.ui.UnitsManager.inputDistanceToMeters(typed)
    }
