...
object ScaleSettings {
    ...
    private var guide: com.rfsat.bas.ui.AimGuide = com.rfsat.bas.ui.AimGuide.CROSS
    private var guideSize: Float = 0.80f
    private var reticle: com.rfsat.bas.ui.Reticle = com.rfsat.bas.ui.Reticle.CROSS
    ...
    fun init(context: Context) {
        ...
        guide = com.rfsat.bas.ui.AimGuide.values()
            .firstOrNull { it.name == p.getString(KEY_GUIDE, null) }
            ?: com.rfsat.bas.ui.AimGuide.CROSS
        guideSize = p.getFloat(KEY_GUIDE_SIZE, 0.80f)
        reticle = com.rfsat.bas.ui.Reticle.values()
            .firstOrNull { it.name == p.getString(KEY_RETICLE, null) }
            ?: com.rfsat.bas.ui.Reticle.CROSS
     ...
     */
    fun reticle(): com.rfsat.bas.ui.Reticle = reticle

    fun setReticle(context: Context, value: com.rfsat.bas.ui.Reticle) {
        reticle = value
        context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).edit()
    ...
    fun aimGuide(): com.rfsat.bas.ui.AimGuide = guide

    fun setAimGuide(context: Context, value: com.rfsat.bas.ui.AimGuide) {
        guide = value
        context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).edit()
