...
import com.rfsat.bas.databinding.ActivitySessionBinding
...
import com.rfsat.bas.scoring.ScoringEngine
import com.rfsat.bas.scoring.ScoringSession
import com.rfsat.bas.scoring.ShotDistribution
...
class SessionActivity : BaseActivity() {
    ...
    private var lastAnnouncedMatch: com.rfsat.bas.ui.GuideMatch? = null
    ...
    private fun initScreen() {
        ...
        binding.spTarget.adapter = com.rfsat.bas.ui.TargetSpinnerAdapter(this, faces)
        ...
        binding.spTarget.onItemSelectedListener = onSelected { i ->
            ...
            binding.crosshair.match = com.rfsat.bas.ui.GuideMatch.UNKNOWN
        ...
        binding.spGuide.adapter = adapter(com.rfsat.bas.ui.AimGuide.values().map { it.label })
        binding.spGuide.setSelection(
            com.rfsat.bas.ui.AimGuide.values().indexOf(ScaleSettings.aimGuide())
        )
        binding.spGuide.onItemSelectedListener = onSelected { i ->
            val chosen = com.rfsat.bas.ui.AimGuide.values()[i]
    ...
    private fun startFreshSession() {
        ...
        com.rfsat.bas.scoring.ScoredPhoto.clear(this)
    }
    ...
    private fun checkFaceAgainstView() {
        if (ScaleSettings.aimGuide() == com.rfsat.bas.ui.AimGuide.NONE) return
        ...
        if (binding.crosshair.match == com.rfsat.bas.ui.GuideMatch.UNKNOWN) {
            binding.crosshair.match = com.rfsat.bas.ui.GuideMatch.CHECKING
        }
        analysisExecutor.execute {
            var state = com.rfsat.bas.ui.GuideMatch.UNKNOWN
            ...
            val complaint = runCatching {
                ...
                state = if (problem == null) com.rfsat.bas.ui.GuideMatch.MATCH
                        else com.rfsat.bas.ui.GuideMatch.MISMATCH
                problem
            }.getOrNull()
            runOnUiThread {
                ...
                if (chosen != null && adoptFace(chosen)) {
                    ...
                    binding.crosshair.match = com.rfsat.bas.ui.GuideMatch.MATCH
                    lastAnnouncedMatch = com.rfsat.bas.ui.GuideMatch.MATCH
