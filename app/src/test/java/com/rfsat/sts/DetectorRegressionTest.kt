...
import com.rfsat.bas.detect.BlackMarkDetector
import com.rfsat.bas.detect.DetectedDisc
import com.rfsat.bas.detect.HoleDetector
import com.rfsat.bas.detect.LumaFrame
import com.rfsat.bas.detect.MaskedIntegralImage
...
class DetectorRegressionTest {
    ...
    fun `a masked integral ignores pixels the camera never covered`() {
        ...
        val naive = com.rfsat.bas.detect.IntegralImage(frame).mean(15, 2, 25, 8)
